...
public class Add extends AppCompatActivity {
    ...
    private void addStudent() {
        ...
        if (student != null) {
            ...
            i.putExtra("new_student", (Serializable) student);
    ...
    private Student getData() {
        ...
        if (TextUtils.isEmpty(gpa)) {
            ipl_gpa.setError("Điểm " + validated_string);
            valid = false;
        } else {
        ...
        if(valid){
            ...
            student = new Student(id,full_name,gt,birth_date,email,dc,chuyen_nganh,Float.parseFloat(gpa),Integer.parseInt(nam));
        }
        return student;
    }
}